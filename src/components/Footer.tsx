function Footer() {
  const links = [
    { name: "LinkedIn", url: "https://linkedin.com/in/kmr-ankit/" },
    { name: "Github", url: "https://github.com/kmr-ankitt" },
    { name: "Instagram", url: "https://instagram.com/kmr_ankitt" },
    { name: "X", url: "https://x.com/kmr-ankitt" },
  ];
  return (
    <div className="w-full flex gap-5 h-screen bg-[#F1F1F1] text-zinc-900 p-20">
      <div className="w-1/2 font-founder flex flex-col justify-between h-full">
        <div className="heading">
          <h1 className="text-[9vw] uppercase leading-none -mb-5">Eye-</h1>
          <h1 className="text-[9vw] uppercase leading-none -mb-5">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 font-founder flex flex-col justify-between h-full">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none -mb-5">
            Presentations
          </h1>
          <div className="dets flex flex-col font-neue text-[1.2vw] mt-10">
